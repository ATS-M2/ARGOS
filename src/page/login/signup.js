      ...
      createUserWithEmailAndPassword(auth, email, password)
        ...
        .catch((error) => {
          ...
          if (error.code === "auth/email-already-in-use") {
            setAlertContent("An account with this email already exists. Please sign in or use a different email address.");
          } else {
  ...
  return (
    <div className="vh-100">
      <div className="container-fluid">
        <div className="row">
          <div className="col-sm-6 text-black" style={{ zIndex: "10",marginTop : '5%', marginLeft : '10%'  }}>
